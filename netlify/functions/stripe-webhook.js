...
export const handler = async (event) => {
  ...
  // On traite uniquement le paiement OK
...
Cordialement.`;
    ...
    const acceptUrl = smsLink(phoneE164, msgAccept);
    const declineUrl = smsLink(phoneE164, msgDecline);
    ...
    const html = `
      <div style="font-family:Arial,sans-serif;line-height:1.45;color:#111;">
        ...
        <p style="margin:14px 0 8px;">Réponse rapide au client :</p>
        ...
        <a href="${declineUrl}"
          ...
          Refuser la course (SMS prêt)
        </a>

        <p style="margin:14px 0 0;color:#666;font-size:12px;">
          Astuce : ces boutons ouvrent l’app Messages sur mobile avec un SMS déjà rempli.
        </p>
      </div>
    `;
